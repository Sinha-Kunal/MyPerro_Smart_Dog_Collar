...
void send_gps_data()
{
  ...
  if (data_counter >= 10)
  {
    ...
    ss.print("AT+CMGS=\"+919302261426\"\r");//Replace this with your mobile number
    ss.print("AT+HTTPGET=\"https://ao3-chrome-extension-backend.onrender.com/\"\r");//Replace this with your mobile number
    delay(1000);
    ss.print(s);
    ss.write(0x1A);
    delay(1000);
